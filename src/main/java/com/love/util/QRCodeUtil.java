...
public class QRCodeUtil {
     ...
     * @param logoImgPath Logo
     * @param needCompress 是否压缩Logo
     * @throws IOException void 添加Logo
     */
     ...
     * @param needCompress 是否压缩Logo
     * @throws Exception void 生成带Logo的二维码
     */
    public static void encode(String content, String logoImgPath, String destPath,
     ...
     * @param content 二维码内容
     * @param destPath 二维码输出路径
     * @throws Exception void 生成不带Logo的二维码
     */
     ...
     * @param output 输出流
     * @param needCompress 是否压缩Logo
     * @throws Exception void 生成带Logo的二维码，并输出到指定的输出流
     */
     ...
     * @param content 二维码内容
     * @param output 输出流
     * @throws Exception void 生成不带Logo的二维码，并输出到指定的输出流
     */
